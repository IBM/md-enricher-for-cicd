...
- If a `phrases.json` value must include quotation marks, you must escape the quotation marks with a backslash. Example: `"{[confirm-icon]}":"<img src=\"images/confirm.svg\" width=\"32\" alt=\"Feature available\" style=\"width:32px;\" />",`
